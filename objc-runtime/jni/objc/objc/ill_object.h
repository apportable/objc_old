...
#define IS_ILL_POINTER(pointer) zzz
#define IS_ILL_OBJECT(receiver) zzz
#define CHECK_ILL_OBJECT_WHEN(object, whenFormat, ...) zzz
#define CHECK_ILL_CLASS_WHEN(clazz, whenFormat, ...) zzz
